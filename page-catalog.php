					...
					<div class="row">
						...
						<div class="portfolio-item col-md-6 code">
							<div class="image-hover">
								<a href="#">
									<figure>
										<img src="<?php the_field('box_image'); ?>" alt="image1" width="330" height="250">
										<div class="overlay">
											<a class="expand" href="<?php the_field('box_link') ?>"></a>
										</div>
									</figure>
									<h3 class="margin-top-20"><a href="<?php the_field('box_link'); ?>">Огнеупорная керамика</a></h3>
									<p class="margin-top-10"><?php the_field('box_excerpt'); ?></p>
								</a>
							</div>
						</div>
